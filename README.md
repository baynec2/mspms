...
# *[mspms](https://bioconductor.org/packages/3.19/mspms)*
...
The goal of *[mspms](https://bioconductor.org/packages/3.19/mspms)* is
...
- *[QFeatures](https://bioconductor.org/packages/3.19/QFeatures)*:
  management and processing of peptide quantitative features and sample
  metadata.

- *[MsCoreUtils](https://bioconductor.org/packages/3.19/MsCoreUtils)*:
...
#>  [37] car_3.1-3                   GenomicRanges_1.56.2       
#>  [39] Rcpp_1.0.13-1               SummarizedExperiment_1.34.0
#>  [41] knitr_1.49                  zoo_1.8-12                 
...
#>  [55] withr_3.0.2                 evaluate_1.0.1             
#>  [57] tmvtnorm_1.6                norm_1.0-11.1              
#>  [59] pillar_1.9.0                BiocManager_1.30.25        
#>  [61] ggpubr_0.6.0                MatrixGenerics_1.16.0      
#>  [63] carData_3.0-5               stats4_4.4.1               
#>  [65] generics_0.1.3              vroom_1.6.5                
#>  [67] S4Vectors_0.42.1            hms_1.1.3                  
#>  [69] ggplot2_3.5.1               munsell_0.5.1              
#>  [71] scales_1.3.0                BiocStyle_2.32.1           
#>  [73] glue_1.8.0                  lazyeval_0.2.2             
#>  [75] tools_4.4.1                 QFeatures_1.14.2           
#>  [77] ggsignif_0.6.4              imputeLCMD_2.1             
#>  [79] mvtnorm_1.3-2               cowplot_1.1.3              
#>  [81] grid_4.4.1                  impute_1.78.0              
#>  [83] tidyr_1.3.1                 MsCoreUtils_1.16.1         
#>  [85] colorspace_2.1-1            GenomeInfoDbData_1.2.12    
#>  [87] Formula_1.2-5               cli_3.6.3                  
#>  [89] fansi_1.0.6                 S4Arrays_1.4.1             
#>  [91] AnnotationFilter_1.28.0     pcaMethods_1.96.0          
#>  [93] gtable_0.3.6                rstatix_0.7.2              
