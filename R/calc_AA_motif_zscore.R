...
#'
#' @param background_count_matrix = this is the count matrix from the background sequences
#' @param background_prop_matrix = this is the proportion matrix from the background sequences
#' @param experimental_count_matrix = this is the count matrix from the experimental sequences
#' @param experimental_prop_matrix = this is the proportion matrix from the experimental sequences
#'
...
calc_AA_motif_zscore = function(background_count_matrix,
  ...
  bg_sd = standard_deviation(background_prop_matrix,
                             experimental_count_matrix)
