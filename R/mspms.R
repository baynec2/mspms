...
#'
#' @param prepared_data = this is data that has been processed by one of the
...
#' @param peptide_library = this is the peptide library that has been used
#'  in the experiment.
#' @param n_residues = this is the number of cleavages to the left and right
