...
#'
#' calculate the percent difference between a matrix of background proportions and a matrix of experimentally observed proportions.
#'
#' @param background_prop_matrix = proportion matrix of aa per position from background cleavage sequences
#' @param experimental_prop_matrix = a proportion matrix of aa per position from experimental cleavage sequences
#'
