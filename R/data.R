...
#'   \item{library_reference_id}{reference id of the detected peptide to that
#'    of the library reported by software}
#'   \item{library_match_sequence}{the sequence match to the peptide library}
#'   \item{library_real_sequence}{the real sequence of the peptide in the
#'    library}
#'   ...
#' }
...
#'
#' data prepared by the mspms package with cleavage information added as
...
#' design matrix
#'
#' example design matrix designed to be used with the peaks processed data
#'  in the readme
#' @format ## `design_matrix`
#' A tibble with 24 rows and 4 columns:
#' \describe{
#'   \item{sample}{sample name as reported by upstream software }
#'   \item{group}{information about what group the sample belongs to, should be
#'    the same for all replicates}
#'   \item{condition}{the condition the sample was exposed to
#'   (commonly a protease inhibitor treatment for example)}
...
#'   \item{Peptide}{Peptide Sequence Detected}
#'   \item{RT}{Retention Time}
#'   \item{Protein Accession}{What each peptide was detected as belonging to
#'   by the upstream data processing software}
...
#' peaks_prepared_data
#' this is an example dataset from peaksthat has been processed by mspms and is
#'  ready for normalyzation.
...
#' joined_with_library
#' this is an example dataset processed by mspms that has been joined with
#' the peptide library
...
#' mspms_data
#' this is an example dataset processed by mspms that has gone through the
#' entire standar workflow
#' @format ## `mspms_data`
