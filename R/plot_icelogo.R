...
plot_icelogo = function(cleavage_seqs,
  ...
  # calculate zscores
  zscores = mspms::calc_AA_motif_zscore(background_count_matrix = background_counts,
  ...
  if(type == "percent_difference"){
    pd = mspms::calc_AA_percent_difference(experimental_prop_matrix = experimental_proprotions,
                                            background_prop_matrix = background_proportions)
    ...
    fc = mspms::calc_AA_fc(experimental_prop_matrix = experimental_proprotions,
                            background_prop_matrix = background_proportions)
