...
process_qf = function(prepared_qf){
  ...
  QF_mod <- QFeatures::impute(prepared_qf_norm,method = "QRILC",
                              i = "peptides_log_norm",
                              name = "peptides_log_impute_norm",MARGIN = 2)

  # Remove Outliers if I can figure it out. 

  # Here we log2 transform the data
  QF_mod <- QFeatures::aggregateFeatures(QF_mod, i = "peptides_log_impute_norm",
