...
Additionally, we provide a [graphical user interface powered by shiny apps](https://gonzalezlab.shinyapps.io/mspms_shiny/) that allows for a user to
...
one function.  
10. *plot_all_icelogos()*: convenience function to plot all icelogos relative to 
